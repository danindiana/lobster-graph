...
function parseNodeWorker(node, isLight) {
    ...
    return {
        ...
        properties: props,
        type: label,
        fx: (props.fx !== undefined && props.fx !== null) ? parseFloat(props.fx) / 50 : (Math.random() * 20 - 10),
        fy: (props.fy !== undefined && props.fy !== null) ? parseFloat(props.fy) / 50 : (Math.random() * 20 - 10),
        fz: 0
    };
}
